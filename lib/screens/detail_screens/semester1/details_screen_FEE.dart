...
class DetailsScreenFEE extends StatefulWidget {
  final String title;
  const DetailsScreenFEE({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  _DetailsScreenFEEState createState() => _DetailsScreenFEEState();
}

class _DetailsScreenFEEState extends State<DetailsScreenFEE> {
  int _selectedTag = 0;
